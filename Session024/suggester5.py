...
def suggest_optimization(df):
    ...
    report += "5. Non-linear Programming:\n"
    report += "   - Used for problems where the objective function or constraints are non-linear.\n"
    ...
    # Call the optimization functions and include their results in the report
    if numeric_columns:
